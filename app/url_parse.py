...
class ReelsParser:
    ...
    def get_reels_videoUrl(self, url):
        ...
        url = o._replace(query='__a=1').geturl()
        try:
    ...
    def __fetch_video_url_from_json(self, json_data):
        image_url = json_data.get('graphql').get('shortcode_media').get('display_url')
...
#test block
#print(ReelsParser().get_reels_videoUrl("https://www.instagram.com/p/CEx-1V-D3h0/?igshid=cufdrobitpo2"))
